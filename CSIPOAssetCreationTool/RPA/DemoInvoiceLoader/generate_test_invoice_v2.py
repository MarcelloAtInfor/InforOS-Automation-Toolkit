...
This version creates a NEW vendor with different line items for testing.
"""
...
def generate_invoice(output_path):
    ...
    pdf.cell(0, 6, 'Purchase Order Number: PO-2026-0042', ln=True)
    pdf.ln(10)
    ...
    vendor_info = [
        'Vendor Name: Global Parts Distribution LLC',
        'Vendor Address: 8500 Industrial Parkway, Detroit, MI 48201',
        'Vendor Phone Number: (313) 555-2468',
        'Vendor Email Address: sales@globalpartsdist.com'
    ]
    ...
    pdf.cell(0, 6, 'Manufacturing Plant - Building C', ln=True)
    ...
    # Line Items Data - Different items for testing
    line_items = [
        ('1', 'MOTOR-AC-5HP', 'AC Electric Motor 5HP 1800RPM', '4', 'EA'),
        ('2', 'PUMP-CENT-200', 'Centrifugal Pump 200GPM Cast Iron', '2', 'EA'),
        ('3', 'VALVE-GATE-4IN', 'Gate Valve 4 Inch Flanged Steel', '12', 'EA'),
        ('4', 'FILTER-HYD-10M', 'Hydraulic Filter Element 10 Micron', '50', 'EA'),
        ('5', 'SEAL-MECH-3IN', 'Mechanical Seal 3 Inch Shaft', '8', 'EA'),
        ('6', 'COUPLING-FLEX', 'Flexible Coupling 1.5 Inch Bore', '6', 'EA'),
    ]
    ...
    pdf.cell(0, 6, 'Shipping Method: Ground Freight', ln=True)
    pdf.cell(0, 6, 'Expected Delivery: 2026-02-05', ln=True)
...
if __name__ == "__main__":
    ...
    output_file = os.path.join(output_dir, "TestInvoice_GlobalParts.pdf")
