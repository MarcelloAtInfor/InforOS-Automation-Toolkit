...
Version 5: Coastal Hydraulics & Pneumatics vendor
"""
...
def generate_invoice(output_path):
    ...
    pdf.cell(0, 6, 'Purchase Order Number: PO-2026-0315', ln=True)
    pdf.ln(10)
    ...
    vendor_info = [
        'Vendor Name: Coastal Hydraulics & Pneumatics',
        'Vendor Address: 8200 Harbor Industrial Way, Long Beach, CA 90802',
        'Vendor Phone Number: (562) 555-9100',
        'Vendor Email Address: orders@coastalhydraulics.com'
    ]
    ...
    # Line Items Data - Hydraulic and pneumatic components
    line_items = [
        ('1', 'HYD-CYL-4X12', 'Hydraulic Cylinder 4in Bore 12in Stroke', '4', 'EA'),
        ('2', 'HYD-HOSE-3/8', 'Hydraulic Hose 3/8in ID 25ft', '10', 'EA'),
        ('3', 'PNEU-FIT-QC', 'Pneumatic Quick Connect Fitting 1/4in', '50', 'EA'),
        ('4', 'HYD-VALVE-DIR', 'Directional Control Valve 4-Way', '6', 'EA'),
        ('5', 'PNEU-CYL-2X6', 'Pneumatic Air Cylinder 2in x 6in', '8', 'EA'),
        ('6', 'HYD-FILTER-10', 'Hydraulic Filter Element 10 Micron', '20', 'EA'),
        ('7', 'PNEU-REG-1/2', 'Air Pressure Regulator 1/2in NPT', '4', 'EA'),
    ]
...
if __name__ == "__main__":
    ...
    output_file = os.path.join(output_dir, "TestInvoice_CoastalHydraulics.pdf")
